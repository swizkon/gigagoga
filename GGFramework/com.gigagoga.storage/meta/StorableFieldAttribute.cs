...
{
    [Obsolete("Use StorableAttribute instead.", true)]
    [AttributeUsage(AttributeTargets.Field)]
    public sealed class StorableFieldAttribute : Attribute
    {
        ...
        public StorableFieldAttribute(StorableFieldDataType dataType)
            : this(null, dataType, StorableFieldInfo.Default)
        {
        }

        public StorableFieldAttribute(String name, StorableFieldDataType dataType)
            : this(name, dataType, StorableFieldInfo.Default)
        {
        }

        public StorableFieldAttribute(String name, StorableFieldDataType dataType, StorableFieldInfo info)
        {
            this.name = name;
